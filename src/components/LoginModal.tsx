      ...
      <div className="relative w-full max-w-md bg-white rounded-[32px] border border-slate-200 shadow-2xl overflow-hidden">
        <div className="p-6 sm:p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-slate-900 tracking-tight">FIGA Video Training</h2>
              <p className="text-sm text-slate-500">Authorized Staff & Admin Portal</p>
            </div>
          </div>
